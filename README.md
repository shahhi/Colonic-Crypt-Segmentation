...
In curve for Train valid loss we can see that training loss is decreasing or stabilizes with every epoch and validation loss is either stabilizing or is decreasing after 17 th epoch. Both are stabilizing hence it can be called reasonaly fitting model. We have achieved accuracy of 79.51% on test set.  
